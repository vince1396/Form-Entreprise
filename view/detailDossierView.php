<div class="container white_body">
    ...
    foreach($req2 as $k => $v){
        ...
        if($v['achat'] == 1){
            ...
            echo '<b>Supplément Copies noires: </b>'.$v['supp_noir'].' € (HT)<br><br>';
            ...
            echo '<b>Date début du contrat: </b>'.$v['date_deb'].'<br><br>';
    ...
    foreach($req5 as $k => $v){
        ...
        if($v['achat_t'] == 1){
            ...
            echo '<b>Prix: </b>'.$v['prix_t'].' €(HT)<br><br>';
            ...
            echo "<h4>Contrat de location:</h4>";
            echo '<b>Loyer: </b>'.$v['prix_t'].' €(HT)<br><br>';
