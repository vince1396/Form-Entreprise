...
<div class="container">
    <div class="row">
        <div class="box">
            ...
            <div class="col-md-6">
                <img class="img-responsive img-border-left" src="img/conteneur.jpg" width ="500" height ="400" alt="">
            </div>
    ...
    foreach ($listeContainers as $container):
        ?>
        <form method="post" action="nosProduits.traitement.php">
            <div class="row">
                <div class="box">
                    <div class="col-lg-12">
                        <hr>
