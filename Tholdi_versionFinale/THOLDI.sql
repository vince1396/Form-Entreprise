...
--
-- Client :  localhost
-- Généré le :  Ven 08 Septembre 2017 à 16:27
...
(9, 'fdsqf', 'fedsqfqf', '95800', 'fdsqfdsq', 'adrien@jgikqjgf.fr', '0130303030', 'PINEL', 'fdsqf', 'aaa', '1');
...
--
ALTER TABLE `PERSONNE`
  MODIFY `CodePersonne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
