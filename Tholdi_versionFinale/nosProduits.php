            ...
            <div class="row">
                <div class="box">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><u>Dimensions:</u><br>
                            Longueur: <?php echo $container["longueurCont"] ?> cm<br>
                            Largeur: <?php echo $container["largeurCont"] ?> cm<br>
                            Poids: <?php echo $container["poidsCont"] ?> cm<br>
                            Poids: <?php echo $container["capaciteDeCharge"] ?> cm<br><br> </p>
                        <p><u>Tarif:</u><br>
                        Journalier: <?php echo $container["tarifJour"] ?> €<br>
                        Trimestriel: <?php echo $container["tarifTrim"] ?> €<br>
                        Annuel: <?php echo $container["tarifAnn"] ?> €<br><br></p>
