    ...
    <div class="row "> 
        ...
        <div class="col-md-7 border">
            ...
            <div class="row">
                    ...
                    <div class="col-md-6">
                        <?php 
                        $collectionGroupes = listeGroupes();
                        foreach ($collectionGroupes as $groupes):
                        ?>
                        <article class="panel panel-default articleEtablissement bgColorTheme">
                                <p> Nom : <?php echo $groupes["nom"]?>  </p>
                                <p> Identite du Responsable : <?php echo $groupes["nom"]?>  </p>
                                <p> Nombre de personnes: <?php echo $groupes["nombrePersonnes"]?>  </p>
                                <p> Pays : <?php echo $groupes["nomPays"]?>  </p>
                            <ol class="breadcrumb">
                                <li> 
