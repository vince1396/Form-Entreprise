...
--
-- Client: localhost
-- Généré le: Lun 05 Janvier 2015 à 15:53
...
CREATE TABLE IF NOT EXISTS `attribution` (
  `idEtab` char(8) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `idGroupe` char(4) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `compte` (
  ...
  `mdp` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`user`)
...
CREATE TABLE IF NOT EXISTS `etablissement` (
  `id` char(8) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `nom` varchar(45) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `adresseRue` varchar(45) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `codePostal` char(5) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `ville` varchar(35) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `tel` varchar(13) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `adresseElectronique` varchar(70) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `type` tinyint(4) NOT NULL,
  `civiliteResponsable` varchar(12) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `nomResponsable` varchar(25) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `prenomResponsable` varchar(25) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
...
('0350123A', 'Collège Lamartine', '3, avenue des corsaires', '35404', 'Saint-Malo', '0299561461', 'lamartine_saintmalo@orange.fr', 1, 'Mme', 'Lefort', 'Anne', 58),
...
('X56894', 'Lycée Jules Ferry', '7 rue Joseph Bouyssel', '78700', 'Conflans Sainte Honorine', '0134900370', '', 1, 'M.', 'Morel', '', 5);
...
CREATE TABLE IF NOT EXISTS `groupe` (
  `id` char(4) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `nom` varchar(40) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `identiteResponsable` varchar(40) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `adressePostale` varchar(120) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `nombrePersonnes` int(11) NOT NULL,
  `nomPays` varchar(40) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `hebergement` char(1) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
