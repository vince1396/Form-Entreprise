	...
	<div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <p>Depuis plus de dix ans maintenant, Sathish Suresh et Adrien Pinel sont à la tête de la société THOLDI, qui est implantée dans plusieurs installations portuaires européennes. Elle est spécialisée dans la gestion de conteneurs destinés au transport de marchandises. <a class="btn btn-primary" href="laSociete.php" role="button">Lire la suite</a> </p>            
                </div>
            </div>
        </div>
